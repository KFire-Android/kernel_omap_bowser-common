...
#define MIX_SWITCH_MM_EXT_UL	ABE_MIXER(23)
#define MIX_SWITCH_VIB_DL	ABE_MIXER(24)
#define ABE_NUM_MONO_MIXERS	(MIX_AUDUL_MONO - MIX_DL1_MONO + 1)
#define ABE_NUM_MIXERS		(MIX_SWITCH_VIB_DL + 1)
...
#define W_VSWITCH_VIB_DL	ABE_WIDGET(41)

#define ABE_NUM_WIDGETS		(W_VSWITCH_VIB_DL - W_AIF_TONES_DL)
#define ABE_WIDGET_LAST		W_VSWITCH_VIB_DL
